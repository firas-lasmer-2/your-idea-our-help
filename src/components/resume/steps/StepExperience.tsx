    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-muted-foreground">
          Ajoutez vos expériences, stages inclus. Utilisez l'IA pour améliorer vos descriptions ! ✨
        </p>
      </div>
      ...
      {data.experience.length === 0 && (
        <Card className="border-dashed">
          <CardContent className="flex flex-col items-center py-10 text-center">
            ...
            <p className="mt-3 text-sm text-muted-foreground">Aucune expérience ajoutée</p>
            <p className="text-xs text-muted-foreground">Stages, emplois, bénévolat — tout compte !</p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input
                    placeholder="Développeur web, Stagiaire marketing..."
                    value={exp.position}
                  ...
                  <Popover open={!!titleSuggestions[exp.id]}>
                    <PopoverTrigger asChild>
                      <Button
                        ...
                        title="Optimiser le titre avec l'IA"
                      >
                    ...
                    <PopoverContent className="w-72" align="end">
                      <div className="space-y-2">
                        <p className="text-sm font-medium text-foreground">Suggestions de titre :</p>
              ...
              <div className="space-y-2">
                ...
                <Input placeholder="Nom de l'entreprise" value={exp.company} onChange={(e) => updateExp(exp.id, { company: e.target.value })} />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-muted-foreground flex items-center gap-1">
                  <Sparkles className="h-3 w-3 text-primary" /> Cliquez ✨ pour améliorer avec l'IA
                </span>
              </div>
              {exp.bullets.map((bullet, bIdx) => {
                ...
                return (
                  <div key={bIdx} className="flex items-center gap-2">
                    ...
                    <Input
                      placeholder="Décrivez une tâche ou réalisation..."
                      value={bullet}
      ...
      {data.experience.length > 0 && (
        <Button onClick={addExperience} variant="outline" className="gap-2">
          <Plus className="h-4 w-4" /> Ajouter une autre expérience
        </Button>
      )}
    </div>
  );
