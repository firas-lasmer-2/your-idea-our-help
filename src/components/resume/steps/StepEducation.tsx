...
function InstitutionCombobox({ value, onChange }: { value: string; onChange: (v: string) => void }) {
  ...
  return (
    <div ref={ref} className="relative">
      <Input
        ...
        placeholder="Tapez ou sélectionnez un établissement..."
      />
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-muted-foreground">
          Ajoutez vos diplômes et formations, du plus récent au plus ancien.
        </p>
      </div>
      ...
      {data.education.length === 0 && (
        <Card className="border-dashed">
          <CardContent className="flex flex-col items-center py-10 text-center">
            ...
            <p className="mt-3 text-sm text-muted-foreground">Aucune formation ajoutée</p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2 sm:col-span-2">
                ...
                <p className="text-[11px] text-muted-foreground">
                  Université, ISET, centre ATFP, lycée, plateforme en ligne...
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input placeholder="Informatique, Gestion..." value={edu.field} onChange={(e) => updateEdu(edu.id, { field: e.target.value })} />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2 sm:col-span-2">
                ...
                <Textarea placeholder="Mention, projets notables, activités..." value={edu.description} onChange={(e) => updateEdu(edu.id, { description: e.target.value })} rows={2} />
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      {data.education.length > 0 && (
        <Button onClick={addEducation} variant="outline" className="gap-2">
          <Plus className="h-4 w-4" /> Ajouter une autre formation
        </Button>
      )}
    </div>
  );
